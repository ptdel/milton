...
import { NestedEnumResourceTypeWithAggregatesFilter } from './nested-enum-resource-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumResourceTypeFilter } from './nested-enum-resource-type-filter.input';

@InputType()
export class EnumResourceTypeWithAggregatesFilter {
